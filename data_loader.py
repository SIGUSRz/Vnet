...
def load_qa_data(data_dir, top_num):
    ...
    val_que_json_path = os.path.join(data_dir,'dev', 'MultipleChoice_mscoco_val2014_questions.json')
    val_ans_json_path = os.path.join(data_dir,'dev', 'mscoco_val2014_annotations.json')
